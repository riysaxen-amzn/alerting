...
import org.opensearch.alerting.monitorRunner.alerts.AlertMover.Companion.moveAlerts
...
import org.opensearch.alerting.monitorRunner.remote.monitors.RemoteDocumentLevelMonitorRunner
import org.opensearch.alerting.monitorRunner.remote.monitors.RemoteMonitorRegistry
...
import org.opensearch.alerting.monitorRunner.settings.AlertingSettings.Companion.INDEX_TIMEOUT
import org.opensearch.alerting.monitorRunner.settings.AlertingSettings.Companion.MAX_ACTIONABLE_ALERT_COUNT
import org.opensearch.alerting.monitorRunner.settings.AlertingSettings.Companion.MOVE_ALERTS_BACKOFF_COUNT
import org.opensearch.alerting.monitorRunner.settings.AlertingSettings.Companion.MOVE_ALERTS_BACKOFF_MILLIS
...
import org.opensearch.alerting.monitorRunner.settings.DestinationSettings.Companion.ALLOW_LIST
import org.opensearch.alerting.monitorRunner.settings.DestinationSettings.Companion.HOST_DENY_LIST
import org.opensearch.alerting.monitorRunner.settings.DestinationSettings.Companion.loadDestinationSettings
...
import org.opensearch.alerting.monitorRunner.util.isDocLevelMonitor
...
object MonitorRunnerService : JobRunner, CoroutineScope, AbstractLifecycleComponent() {
    ...
    fun isActionActionable(action: Action, alert: Alert?): Boolean {
