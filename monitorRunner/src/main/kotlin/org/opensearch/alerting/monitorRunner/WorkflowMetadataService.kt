...
object WorkflowMetadataService :
    ...
    fun initialize(
        ...
        indexTimeout = AlertingSettings.INDEX_TIMEOUT.get(settings)
        WorkflowMetadataService.clusterService.clusterSettings.addSettingsUpdateConsumer(AlertingSettings.INDEX_TIMEOUT) { indexTimeout = it }
    }
