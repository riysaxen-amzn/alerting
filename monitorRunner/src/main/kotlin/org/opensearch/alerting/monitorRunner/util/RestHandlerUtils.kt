...
package org.opensearch.alerting.monitorRunner.util
...
fun context(request: RestRequest): FetchSourceContext? {
    ...
    return if (!userAgent.contains("OpenSearch-Dashboards")) {
        FetchSourceContext(true, Strings.EMPTY_ARRAY, arrayOf("monitor.${Monitor.UI_METADATA_FIELD}"))
    } else null
}
